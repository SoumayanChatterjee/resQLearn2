...
//       {/* Header */}
//       <header className="bg-slate-800 shadow-sm fixed top-0 left-0 w-full z-20">
//         <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
//           <h1 className="text-2xl font-bold text-white">ResQLearn</h1>
//           <ul className="flex space-x-8 items-center text-gray-300 font-medium">
//             <li>
//               <Link href="/" className="hover:text-gray-300 transition hover:underline">Home</Link>
//             </li>
//             <li>
//               <a href="#about" className="hover:text-blue-600 transition hover:underline">About Us</a>
//             </li>
//             <li>
//               <a href="#contact" className="hover:text-blue-600 transition hover:underline">Contact</a>
//             </li>
//             <li>
//               <Link href="/login" className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-500 transition shadow-sm">
//                 Logout
//               </Link>
//             </li>
//             <li>
//               <Link href="/signup" className="bg-white text-blue-600 px-4 py-2 rounded-md border border-blue-600 hover:bg-blue-50 transition shadow-sm">
//                 Profile
//               </Link>
//             </li>
//           </ul>
...
//   return (
//     <div className="bg-white rounded-xl shadow-md transition transform p-6 text-center
