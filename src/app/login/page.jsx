...
//       const data = await res.json();
//       if (data.success) {
//         if (data.user.role === "admin") router.push("/admin-home");
...
//   return (
//     <div className="relative min-h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: "url('/login_bg3.png')" }}>
//       <div className="absolute inset-0 bg-black/50 backdrop-blur-sm"></div>

//       <div className="relative flex bg-white/90 rounded-xl shadow-2xl overflow-hidden w-3/4 max-w-4xl">
//         <div className="w-1/2 bg-slate-100 flex flex-col items-center justify-center p-10">
//           <img src="/login_welcome2.jpg" alt="Login Illustration" className="max-w-xs w-full h-auto mb-6 rounded-lg shadow" />
//           <h2 className="text-2xl font-bold mb-4">Welcome to ResQLearn!</h2>
//           <p className="text-gray-600 text-center">Providing disaster preparedness education for schools and colleges.</p>
//         </div>
...
//           <div className="flex mb-6">
//             <button type="button" className={`flex-1 py-2 rounded-l-lg ${role === "student" ? "bg-blue-800 text-white" : "bg-gray-200"}`} onClick={() => setRole("student")}>
//               Student
//             </button>
//             <button type="button" className={`flex-1 py-2 rounded-r-lg ${role === "admin" ? "bg-blue-800 text-white" : "bg-gray-200"}`} onClick={() => setRole("admin")}>
//               Admin
//             </button>
//           </div>
...
//             <button type="submit" className="w-full bg-blue-800 text-white py-2 rounded hover:bg-blue-600">Log in</button>
//           </form>

//           <p className="mt-4 text-sm text-gray-600">Don’t have an account? <a href="/signup" className="text-blue-500 hover:underline">Sign up here</a></p>
//         </div>
//       </div>
//     </div>
//   );
